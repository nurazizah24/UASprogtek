...
public class halaman_inhistori_pesanan_kursus_murid_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view=(ViewGroup) inflater.inflate(R.layout.activity_halaman_inhistori_pesanan_kursus_murid, container, false);
...
return view;
    ...
    private void getAlldataGuru(String username_murid){
        ...
        String url=Global.base_url+"controller_getAllDataguru_pesanan_murid_inhistori.php";
